...
const (
	CreateCommentMethodName   = "CreateComment"
	GetCommentListMethodName  = "GetCommentList"
	GetCommentMethodName      = "GetComment"
	DeleteCommentMethodName   = "DeleteComment"
	GetUserCommentsMethodName = "GetUserComments"
)
